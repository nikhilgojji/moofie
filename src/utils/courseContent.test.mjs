...
test("course resource mapping carries Modules Home, full content and all accessible People", async () => {
  ...
  const load = new Function("optionalCanvasRequest", "optionalCanvasList", "canvasList", "safeLink", "completeModules", "moduleExternalUrl", "mapCoursePerson", resourceCode + "\nreturn courseResources;")(request, list, list, safeLink, completeModules, moduleExternalUrl, mapCoursePerson);
